...
PORT = 80
SOCKET_TIMEOUT = 2
CONTENT_TYPE_DIC = {"Html": "text/html;charset=utf-8", "jpg": "image/jpeg", "css": "text/css",
...
breaking up the http request
handleing the request:
    getting the right recources according to request
    reparsing http response
